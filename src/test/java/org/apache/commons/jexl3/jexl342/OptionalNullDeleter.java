...
/**
 * JexlPropertyDelete on a reference that pointed null.
 * <p>Performs a late discovery of the actual getter.</p>
 */
public class OptionalNullDeleter implements JexlPropertyDelete {
    /** The Uberspect to discover the deleter. */
    private final JexlUberspect uberspect;
    /** The property we are trying to discover. */
    private final Object property;
    /** The result when we solve it. */
    private JexlPropertyDelete delegate;

    OptionalNullDeleter(JexlUberspect jexlUberspect, Object key) {
    ...
    public Object invoke(Object obj) throws Exception {
        ...
        if (delegate == null) {
            delegate = uberspect.getPropertyDelete(obj, property);
            if (delegate == null) {
